...
import { createEventListenerWrapperWithPriorty } from './ReactDOMEventListener'
...
export function listenToNativeEvent(domEventName, isCapturePhaseListener, target) {
  let eventSystemFlags = 0 //标识冒泡还是捕获，0=冒泡 4=捕获
...
function addTrappedEventListener(targetContainer, domEventName, eventSystemFlags, isCapturePhaseListener) {
  const listener = createEventListenerWrapperWithPriorty(targetContainer, domEventName, eventSystemFlags)
  if (isCapturePhaseListener) {
...
export function accumulateSingelPhaseListeners(
  targetFiber,
  reactName,
  nativeEventType,
  isCapturePhase
